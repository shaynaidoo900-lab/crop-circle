        ...
        {isLoading ? (
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-muted/50 rounded-lg p-4 text-center space-y-2">
              <div className="skeleton w-10 h-3 mx-auto rounded" />
              <div className="skeleton w-12 h-10 mx-auto rounded" />
              <div className="skeleton w-8 h-3 mx-auto rounded" />
            </div>
            <div className="bg-muted/50 rounded-lg p-4 text-center space-y-2">
              <div className="skeleton w-10 h-3 mx-auto rounded" />
              <div className="skeleton w-12 h-10 mx-auto rounded" />
